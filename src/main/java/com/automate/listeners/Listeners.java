...
public class Listeners implements ITestListener, ISuiteListener {
  ...
  public void onTestStart(ITestResult result) {
    ...
    ExtentReportLogger.logInfo("TestCase execution - <b>" + result.getMethod().getMethodName() + "</b> has begun");
  }

  @Override
  public void onTestSuccess(ITestResult result) {
    ExtentReportLogger.logPass("TestCase - <b>" + result.getMethod().getMethodName() + "</b> is passed");
  }

  @Override
  public void onTestFailure(ITestResult result) {
    ExtentReportLogger.logFail("TestCase - <b>" + result.getMethod().getMethodName() + "</b> is failed", result.getThrowable());
  }

  @Override
  public void onTestSkipped(ITestResult result) {
    ExtentReportLogger.logSkip("TestCase - <b>" + result.getMethod().getMethodName() + "</b> is skipped");
  }
